...
function LoginPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#fafafa', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      ...
      {/* 로고 */}
      <div onClick={() => navigate('/')} style={{ fontSize: '24px', fontWeight: '900', color: '#ff2351', letterSpacing: '-2px', cursor: 'pointer', marginBottom: '36px', userSelect: 'none' }}>
        VIVID HW
      </div>
      ...
      <div style={{ width: '100%', maxWidth: '400px', backgroundColor: '#fff', borderRadius: '20px', padding: '44px 40px', boxShadow: '0 8px 32px rgba(0,0,0,0.08)', border: '1px solid #f0f0f0' }}>
        ...
        {/* 탭 전환 */}
        <div style={{ display: 'flex', borderBottom: '1px solid #ebebeb', marginBottom: '32px', gap: '0' }}>
          {['로그인', '회원가입'].map((label, i) => (
            <button
              ...
              style={{
                ...
                color: (isLoginView ? i === 0 : i === 1) ? '#0a0a0a' : '#bbb',
                borderBottom: (isLoginView ? i === 0 : i === 1) ? '2.5px solid #0a0a0a' : '2.5px solid transparent',
        ...
        <form onSubmit={isLoginView ? handleLogin : handleSignup}>
          ...
          <div style={{ marginBottom: '26px' }}>
            ...
            <input
              type="password" placeholder="비밀번호를 입력하세요" value={password}
        ...
        <p style={{ textAlign: 'center', marginTop: '20px', fontSize: '13px', color: '#aaa' }}>
          ...
          <span
            ...
            style={{ color: '#ff2351', fontWeight: '700', cursor: 'pointer' }}
          >
